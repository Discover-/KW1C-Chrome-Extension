...
chrome.runtime.sendMessage({method: "getLocalStorage", key: "store.settings.password"}, function(response)
{
	...
	if (-1 != document.URL.indexOf("stud_rooster.aspx"))
	{
		try
		{
			//@todo: delay this until it loaded the html of the page
			document.getElementById('ctl00_ContentPlaceHolder1_btnVerder').click();
			return;
		}
		catch(e){}
	}
